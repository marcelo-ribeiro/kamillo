...
const platformLogos = [
  { 
    ...
    className: "brightness-0 opacity-40 hover:opacity-100" 
  },
  { 
    name: "Meta Ads", 
...
export function Stats() {
  return (
    <section className="py-24 relative overflow-hidden bg-[#FBFAF9]">
      ...
      <div className="absolute -right-20 -top-20 opacity-[0.03] pointer-events-none select-none">
        <img 
          src="/brand/logo.png" 
          alt="" 
          className="w-[600px] h-auto object-contain grayscale opacity-[0.04] invert"
        />
      </div>
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        {/* Logos Bar */}
        <div className="mb-20">
          <p className="text-center text-black/30 text-xs uppercase tracking-[0.3em] font-bold mb-10">Parceiros e Plataformas</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {stats.map((stat, i) => (
            ...
            >
              ...
              <p className="text-black/40 text-xs uppercase tracking-widest font-bold mb-2">{stat.label}</p>
              <h3 className="text-4xl font-display font-bold text-black mb-2">{stat.value}</h3>
              <p className="text-black/40 text-sm leading-relaxed">{stat.sub}</p>
