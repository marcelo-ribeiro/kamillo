  ...
  return (
    <section id="hero" className="relative min-h-screen flex items-center pt-20 overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-full h-full -z-10">
        ...
        <div className="absolute bottom-[-10%] right-[-10%] w-[50%] h-[50%] bg-secondary/10 rounded-full blur-[120px] animate-pulse-slow font-delay-2000" />
      ...
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <h1 className="text-5xl md:text-7xl font-display font-bold leading-[1.1] mb-6 [text-shadow:_0_1px_20px_rgba(255,255,255,0.05)]">
              Engenharia de <br />
          ...
          <div className="mt-12 flex items-center gap-4 py-4 px-6 glass rounded-2xl w-fit">
            <div className="flex -space-x-3">
              {[1, 2, 3, 4].map((i) => (
                <div key={i} className="w-10 h-10 rounded-full border-2 border-deep bg-white/10 overflow-hidden">
                  <img src={`https://i.pravatar.cc/100?img=${i + 10}`} alt="Client" className="w-full h-full object-cover" />
                </div>
              ))}
            </div>
            <div className="text-sm">
              <p className="font-bold text-white">+100 empresas</p>
              <p className="text-white/40 text-xs">atendidas com sucesso</p>
            </div>
          </div>
        </motion.div>
        ...
        >
          ...
          <div className="relative aspect-square md:aspect-[4/3] lg:aspect-square">
            ...
            <motion.div 
              ...
              className="absolute inset-0 rounded-3xl overflow-hidden border border-white/10 z-10 shadow-2xl"
            >
              <img 
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-[10px] text-white/40 uppercase font-black tracking-tighter">Growth Rate</p>
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-[10px] text-white/40 uppercase font-black tracking-tighter">Elite Traffic</p>
