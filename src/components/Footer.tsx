  ...
  return (
    <footer className="py-12 border-t border-white/5 bg-black">
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
            ...
            <Link href="/" className="flex items-center gap-3 mb-6">
              ...
              <div className="flex flex-col border-l border-white/10 pl-3">
                <img 
                  ...
                  alt="KJS Consultoria" 
                  className="h-5 md:h-6 w-auto object-contain opacity-90 transition-opacity hover:opacity-100"
                />
              </div>
            </Link>
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm">
              <li><Link href="#hero" className="text-white/40 hover:text-white transition-colors">Home</Link></li>
              <li><Link href="#servicos" className="text-white/40 hover:text-white transition-colors">Serviços</Link></li>
              <li><Link href="#resultados" className="text-white/40 hover:text-white transition-colors">Resultados</Link></li>
              <li><Link href="#sobre" className="text-white/40 hover:text-white transition-colors">Sobre</Link></li>
            </ul>
          </div>
        ...
        <div className="pt-8 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-4 text-[10px] text-white/20 uppercase font-bold tracking-widest">
